...
from openpyxl import BarChart3D, Reference
...
def create_excel_data(sheet):
    data_rows = [
        ...
        ["ReportLab: PDF Processing with Python", 4.99, 25.99],
        ["Jupyter Notebook 101", 4.99, 25.99],
        ["Creating GUI Applications with wxPython", 4.99, 25.99],
